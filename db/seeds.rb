...
exercises = []
exercises << Course::Exercise.create!(data: {'content_of_exercise' => '<h2>Wyświetl na ekranie 44</h2>Użyj polecenie puts aby wyświetlić w języku Ruby liczbę czterdzieści i cztery.', 'code' => '# Tutaj początek kodu', 'code_locks' => [{'rowStart' => 0, 'colStart' => 0, 'rowEnd' => 1, 'colEnd' => 1}], 'allow_user_input' => false, 'default_user_input' => '', 'expected_result_expr' => '55', 'code_before' => '', 'code_after' => '', 'lang' => 'RUBY'})
