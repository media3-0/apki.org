...
course = Course::CourseDatum.new(data: {"title" => "Pierwszy testowy kurs", "description" => "Oto testowy kurst który jest dla testu. Check this out!", "icon_src" => "", "difficulty_level" => 1, "dependencies" => [],
                                        "lessonsPassed" => [],
                                        "lessonCurrent" => ""})

lesson = Course::Lesson.new(data: {"title" => "sample lesson 1",
...
quizzes = []
quizzes << Course::Quiz.create!(data: {"question" => "Co działa lepiej? Front-end czy back-end?",
                                       "answer_idx" => 2,
                                       "answers" => [
                                           "Front-end",
                                           "Back-end",
...
quizzes << Course::Quiz.create!(data: {"question" => "Czy Sławek lubi się bawić swoim Pythonem?",
                                       "answers" => [
                                           "Tak",
                                           "Nie"
                                       ],
                                       "answer_idx" => 0})
quizzes << Course::Quiz.create!(data: {"question" => "Jaka jest odpowiedź na życie, wszechświat i wszystko?",
                                       "answers" => [
                                           "Tak",
                                           "Love is the Answer",
                                           "42"
...
lesson = Course::Lesson.new(data: {"title" => "sample lesson 2",
...
exercises = []
exercises << Course::Exercise.create!(data: {'content_of_exercise' => '<h2>Wyświetl na ekranie 44</h2>Użyj polecenie puts aby wyświetlić w języku Ruby liczbę czterdzieści i cztery.', 'code' => '# Tutaj początek kodu\n ', 'code_locks' => [{'rowStart' => 0, 'colStart' => 0, 'rowEnd' => 0, 'colEnd' => 100}], 'allow_user_input' => false, 'default_user_input' => '', 'expected_result_expr' => '44', 'code_before' => '', 'code_after' => '', 'lang' => 'RUBY'})
